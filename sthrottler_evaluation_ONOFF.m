...
E_oracle1y = [E_oracle11; [ML1Y(ML1Y(:,1)>=d_short,1) zeros(length(ML1Y(ML1Y(:,1)>=d_short,1)),1)+E_oracle1y(end)]];
...
E_oracle3y = [E_oracle12; [ML3Y(ML3Y(:,1)>=d_long,1) zeros(length(ML3Y(ML3Y(:,1)>=d_long,1)),1)+E_oracle3y(end)]];
